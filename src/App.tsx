  ...
  return (
    <div className="app-shell">
      <aside className="sidebar">
        <div className="brand"><span className="brand-mark">r</span><span>rank</span></div>
      ...
      <main className="main-content">
        ...
        <section className="content-wrap">
          ...
          <div className="lower-grid"><section className="panel activity-panel"><div className="panel-heading"><div><h2>Recent activity</h2><p>Your latest updates and actions</p></div><button className="more-button">•••</button></div><div className="activity-list"><div className="activity-row"><span className="activity-icon green">✓</span><span><strong>Marks submitted</strong><small>Database Systems · CSE 3B</small></span><time>2h ago</time></div><div className="activity-row"><span className="activity-icon blue">↗</span><span><strong>Class report exported</strong><small>Data Structures · CSE 3A</small></span><time>Yesterday</time></div><div className="activity-row"><span className="activity-icon yellow">!</span><span><strong>6 students need attention</strong><small>Data Structures · CSE 3A</small></span><time>Sep 5</time></div></div></section><section className="insight-card"><div className="insight-orb">✦</div><p className="eyebrow">Rank insights</p><h2>Your students are trending up.</h2><p>Average performance has grown by 4.6% this semester. Keep the momentum going.</p><button className="insight-button" onClick={() => setActiveNav('Analytics')}>Explore analytics <span>→</span></button></section></div>
        </section>
      </main>
    </div>
  )
